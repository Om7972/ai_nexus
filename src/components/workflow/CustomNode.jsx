...
import {
  ...
  Send, CheckCircle, Zap
} from 'lucide-react';

const nodeIcons = {
  userInput: User,
  promptNode: MessageSquare,
  llmNode: Brain,
  imageGeneration: Image,
  conditionNode: GitBranch,
  apiRequest: Send,
  outputNode: CheckCircle
};

const nodeColors = {
  userInput: 'from-blue-500 to-cyan-500',
  promptNode: 'from-purple-500 to-pink-500',
  llmNode: 'from-green-500 to-emerald-500',
  imageGeneration: 'from-orange-500 to-red-500',
  conditionNode: 'from-yellow-500 to-amber-500',
  apiRequest: 'from-indigo-500 to-blue-500',
  outputNode: 'from-teal-500 to-green-500'
};
